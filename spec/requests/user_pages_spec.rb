...
describe "User pages" do
  ...
  describe "edit" do
    ...
    describe "with valid information" do
      ...
      specify { user.reload.last_name.should == new_name }
  ...
  describe "following/followers" do
    ...
    describe "followed users" do
      ...
      it { should have_link(other_user.last_name, href: user_path(other_user)) }
    end
    ...
    describe "followers" do
      ...
      it { should have_link(user.last_name, href: user_path(user)) }
    end
  end
end